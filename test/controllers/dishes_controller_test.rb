...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { desc: @dish.desc, name: @dish.name, price: @dish.price } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { desc: @dish.desc, name: @dish.name, price: @dish.price } }
